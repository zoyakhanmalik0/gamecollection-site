...
const DownloadPage = () => {
  const greenGradient =
    'from-green-400 to-emerald-600 hover:from-green-600 hover:to-emerald-700';
      ...
      <div className="w-full max-w-md space-y-4 mb-10">
        {buttons.map(({ label, href }, index) => (
          <a
            ...
            className={`flex w-full items-center justify-center gap-3 bg-gradient-to-r ${greenGradient} text-white text-sm font-semibold py-3 px-4 rounded-xl shadow-lg transition duration-300`}
          >
            <Download size={16} />
            {label}
          </a>

...
const WelcomeSection = () => {
  return (
    <div className="bg-white w-full rounded-none shadow-lg overflow-hidden mb-12 min-h-[600px]">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 px-4 sm:px-8 md:px-16 py-8 md:py-12 h-full">
        {/* Left Text Section */}
        <div className="py-2 sm:py-4">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800 mb-6">
            Welcome to Offici Dragon Tiger Club Guide
          </h2>
          <p className="text-base sm:text-lg text-gray-700 mb-8 leading-relaxed">
            Looking for a gaming blog that keeps things smart, fun, and totally entertaining?
            <span className="font-bold"> Dragon Tiger Club</span> is your go-to source for informative game articles,
          ...
          <div className="space-y-6">
            <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-800">
              What You'll Find on <span className="text-yellow-600">officialdragontigerclub.online</span>
            </h3>
        ...
        <div className="h-full w-full">
          <img
            src="https://static.toiimg.com/thumb/89843952/89843952.jpg?height=746&width=420&resizemode=76&imgsize=3024042"
            alt="Gaming Content"
